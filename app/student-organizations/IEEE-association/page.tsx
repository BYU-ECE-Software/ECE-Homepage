    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-6 py-12">
        <p className="text-byu-medium-gray">
          Placeholder page for the IEEE student charter. Unlike the other
          organizations on the Student Organizations page, which link out to
          each club&apos;s own website, this one links to a page hosted
          right here on the department site.
        </p>

        <Link
          href="/student-organizations"
          className="mt-8 inline-block font-medium text-byu-royal"
        >
