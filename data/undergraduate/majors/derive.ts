...
import type { FlowchartSet, MajorConfig, NavSection, PageContent, ResourceCardData } from './types';
 ...
 */
export const DEPARTMENT_COURSE_CATALOG_URL = 'https://catalog.byu.edu/departments/1130/courses';
...
function buildFlowchartCards(major: MajorConfig, flowcharts: FlowchartSet): ResourceCardData[] {
  ...
  return flowcharts.years.map((year) => {
    ...
    return {
      ...
      image:
        flowcharts.hasPreviewImages === false ? undefined : `${base}/flowchart-pngs/${year}.png`,
 ...
 */
export function buildMajorPages(major: MajorConfig): Record<string, PageContent> {
    ...
    home: {
      ...
      cards: [
        ...
        },
        {
          ...
          description: 'Meet with an advisor to plan your semesters and stay on track to graduate.',
          href: `${basePath}/academic-advising`,
          linkText: 'Meet your advisors',
        },
        {
          title: 'Graduation Flowcharts',
          description: 'Semester-by-semester course maps for each catalog year in the program.',
